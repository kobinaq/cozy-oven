    ...
    <>
      ...
      <main className="editorial-shell">
          ...
          <div className="relative grid min-h-[560px] -translate-y-6 place-items-center lg:min-h-[650px] lg:-translate-y-14">
            ...
            <article className="float-card relative w-[min(440px,88vw)] overflow-hidden rounded-[44px] border border-[rgba(48,23,15,0.1)] bg-gradient-to-b from-[#FFFDF7]/95 to-[#F7EAD6]/95 p-5 shadow-[0_26px_80px_rgba(48,23,15,0.16)]">
              ...
              <div className="px-2 pb-2">
                ...
                <Link href="/shop" className="mt-5 inline-flex rounded-full bg-[#C97D35] px-5 py-3 font-black text-[#FFFDF7]">
                  Add to cart
                </Link>
              </div>
            </article>
            <aside className="absolute right-0 top-14 hidden max-w-[220px] rounded-[22px_22px_22px_6px] border border-[rgba(48,23,15,0.08)] bg-[#FFFDF7] p-4 shadow-[0_12px_40px_rgba(48,23,15,0.10)] md:block">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8 lg:pb-28">
          <div className="relative grid overflow-hidden rounded-[46px] bg-gradient-to-br from-[#30170F] via-[#6B3925] to-[#C77835] p-7 text-[#FFF8EC] shadow-[0_26px_80px_rgba(48,23,15,0.16)] md:grid-cols-[1fr_0.8fr] md:p-12 lg:p-16">
            <div className="relative z-10">
              ...
              <div className="mt-7 grid max-w-2xl grid-cols-2 gap-3 sm:grid-cols-4">
                {["Birthday", "Thank you", "Office treat", "Get well soon"].map((occasion) => (
                  <span
                    key={occasion}
                    className="rounded-full border border-white/20 bg-white/10 px-4 py-3 text-center text-sm font-black text-[#FFF8EC]"
                  >
                    {occasion}
                  </span>
                ))}
              ...
              <Link
                ...
                className="mt-8 inline-flex rounded-full bg-[#FFF8EC] px-7 py-4 font-black text-[#30170F] shadow-[0_16px_30px_rgba(48,23,15,0.18)] transition hover:-translate-y-1"
              >
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              <article key={number} className="rounded-[30px] border border-[rgba(48,23,15,0.09)] bg-[#FFFDF7]/78 p-7 shadow-[0_12px_40px_rgba(48,23,15,0.10)]">
                <span className="mb-5 grid h-12 w-12 place-items-center rounded-full bg-[#F3C667] font-black text-[#30170F]">
                  {number}
                </span>
                <h3 className="mb-3 text-xl font-black text-[#30170F]">{title}</h3>
                <p className="leading-7 text-[#80634F]">{copy}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
          ...
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
            <div className="rounded-[42px] bg-[#1F120F] p-5 shadow-[0_26px_80px_rgba(48,23,15,0.16)]">
              <div className="flex items-center gap-3 px-3 pb-4 text-[#FFF8EC]">
            ...
            <div className="grid content-start gap-4">
              ...
              <a
                ...
                className="mt-2 inline-flex w-fit items-center gap-2 rounded-full bg-[#2F855A] px-6 py-4 font-black text-white shadow-[0_16px_30px_rgba(48,23,15,0.18)] transition hover:-translate-y-1"
              >
        ...
        <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8 lg:pb-28">
          <div className="grid items-center gap-10 rounded-[44px] border border-[rgba(48,23,15,0.09)] bg-[#FFFDF7]/78 p-7 shadow-[0_12px_40px_rgba(48,23,15,0.10)] md:grid-cols-[300px_1fr] md:p-12">
            <div className="grid aspect-square w-full max-w-[260px] place-items-center rounded-[38px] bg-gradient-to-br from-[#F3C667] via-[#C97D35] to-[#5B3322] shadow-[0_26px_80px_rgba(48,23,15,0.16)] md:-rotate-3">
              <span className="text-8xl font-black text-[#FFF8EC]">A</span>
            </div>
            <div>
          ...
          <div className="grid max-w-4xl gap-3">
            {faqs.map((faq, index) => (
              <details
                key={faq.id}
                open={index === 0}
                className="rounded-[22px] border border-[rgba(48,23,15,0.09)] bg-[#FFFDF7]/78 p-5 shadow-[0_12px_40px_rgba(48,23,15,0.10)]"
              >
                <summary className="cursor-pointer text-lg font-black text-[#30170F]">
                  {faq.question}
                </summary>
                <p className="mt-3 leading-7 text-[#80634F]">{faq.answer}</p>
              </details>
            ))}
          </div>
        </section>
